...
public class OVRGrabbable : MonoBehaviour
{
	...
	virtual public void GrabBegin(OVRGrabber hand, Collider grabPoint)
    {
        ...
        // Use reflection to get the RealtimeTransform type, because Oculus's asmdef file blocks access to outside scripts.
        Type realtimeTransformType = Type.GetType("Normal.Realtime.RealtimeTransform,Assembly-CSharp");
        MonoBehaviour realtimeTransform = gameObject.GetComponent(realtimeTransformType) as MonoBehaviour;
        realtimeTransform.Invoke("RequestOwnership", 0.0f);
