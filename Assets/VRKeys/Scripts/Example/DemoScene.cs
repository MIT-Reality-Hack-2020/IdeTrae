...
namespace VRKeys {
	...
	public class DemoScene : MonoBehaviour {
		...
		private void OnEnable () {
            ...
            /*
            keyboard.Enable ();
			keyboard.SetPlaceholderMessage ("Enter a snappy title!");
        ...
        */
		...
		public void HandleSubmit (string text) {
            ...
            UIParent UIParent = GameObject.Find("UIParent").GetComponent<UIParent>();
            UIParent.title = text;
            UIParent.mode = UIParent.Mode.ideaDone;
		}
        */
		...
		public void HandleCancel () {
            ...
            UIParent UIParent = GameObject.Find("UIParent").GetComponent<UIParent>();
            UIParent.mode = UIParent.Mode.neutral;
		}
        */
